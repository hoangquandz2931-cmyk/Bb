...
game:GetService("Players").LocalPlayer.Idled:connect(function()
    ...
    function library:AddWindow(text,keybind)
        ...
        DoctorShiba.ResetOnSpawn = false
        DoctorShiba.DisplayOrder = 1000
        DoctorShiba.IgnoreGuiInset = true
        DoctorShiba.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
        pcall(function() DoctorShiba.Parent = game.CoreGui end)
        if not DoctorShiba.Parent then DoctorShiba.Parent = game:GetService("Players").LocalPlayer.PlayerGui end
...
local SOMEXHUB = library:AddWindow("Falre X hub",Enum.KeyCode.RightControl)
