		...
		if (L_48_[3]["Position"] - L_45_[5]["Position"])["Magnitude"] <= L_45_[8] then
			...
			for L_53_forvar0, L_54_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
				...
				if L_55_[4] and (L_55_[1] and (L_55_[4]["Health"] > 0 and L_55_[5]["Name"] == L_48_[1]["Name"])) then
					L_52_[2] += L_55_[1]["Position"]
					L_52_[3] += 1
				end
			end
			L_52_[1] = L_52_[3] > 0 and L_52_[2] / L_52_[3] or PosMon
			L_52_[4] = CFrame["new"](L_52_[1])
			L_52_[5] = (L_48_[3]["Position"] - L_52_[4]["Position"])["Magnitude"]
			if L_52_[5] > 3 then
				local L_56_ = {}
				local tweenTime = math.clamp(L_52_[5] / math.max(L_45_[7], 1), 0.05, 0.3)
				L_56_[2] = TweenInfo["new"](tweenTime, Enum["EasingStyle"]["Linear"]);
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/luyenphamdinh81-hash/Nguyenkhang-hub/refs/heads/main/Fast%20attack"))()(game:HttpGet("https://raw.githubusercontent.com/luyenphamdinh81-hash/Nguyenkhang-hub/refs/heads/main/Fast%20attack"))()